...
interface ScratchSpaceProps {
  title: string
  variant: 'default' | 'ai-response' | 'conflict' | 'conflict-version'
  content: string
  collapsed?: boolean
}

export function ScratchSpace({ title, variant = 'default', content, collapsed: initialCollapsed = true }: ScratchSpaceProps) {
