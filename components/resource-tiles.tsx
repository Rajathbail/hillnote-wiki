...
export function ResourcePDF({ src, title }: ResourcePDFProps) {
  const handleOpen = () => {
    // Resolve the URL
    let url = src
...
interface ResourceHTMLProps {
  src: string
  title: string
}

export function ResourceHTML({ src, title }: ResourceHTMLProps) {
  const handleOpen = () => {
    // Resolve the URL
    let url = src
...
interface ResourceYouTubeProps {
  videoId: string
  title: string
}

export function ResourceYouTube({ videoId, title }: ResourceYouTubeProps) {
...
export function ResourceFile({ path, name, type }: ResourceFileProps) {
